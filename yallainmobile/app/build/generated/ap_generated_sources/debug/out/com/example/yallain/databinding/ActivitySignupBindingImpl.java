...
public class ActivitySignupBindingImpl extends ActivitySignupBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.yallaInText, 1);
        sViewsWithIds.put(R.id.yallaInSignupText, 2);
        sViewsWithIds.put(R.id.signup_full_name, 3);
        sViewsWithIds.put(R.id.sexRadiogroup, 4);
        sViewsWithIds.put(R.id.maleRadioButton, 5);
        sViewsWithIds.put(R.id.femaleRadioButton, 6);
        sViewsWithIds.put(R.id.signup_dob, 7);
        sViewsWithIds.put(R.id.signup_email, 8);
        sViewsWithIds.put(R.id.signup_password, 9);
        sViewsWithIds.put(R.id.signup_confirm, 10);
        sViewsWithIds.put(R.id.signup_button, 11);
        sViewsWithIds.put(R.id.loginRedirectText, 12);
    }
    // views
    @NonNull
