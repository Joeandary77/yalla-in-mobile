...
public abstract class ActivityLoginBinding extends ViewDataBinding {
  ...
  @NonNull
  public final TextView yallaInLoginText;

  @NonNull
  public final TextView yallaInText;

  protected ActivityLoginBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button loginButton, EditText loginEmail, EditText loginPassword, TextView signupRedirectText,
      TextView yallaInLoginText, TextView yallaInText) {
    super(_bindingComponent, _root, _localFieldCount);
    this.loginButton = loginButton;
    this.loginEmail = loginEmail;
    this.loginPassword = loginPassword;
    this.signupRedirectText = signupRedirectText;
    this.yallaInLoginText = yallaInLoginText;
